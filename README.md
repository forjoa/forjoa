...
My name is Joaquin Trujillo, I'm a web aplication developer based in Madrid. Always practicing by making my own projects because "the best way to learn to code, is coding!".
...
- <p style="display: flex; align-items: center;">Programming languages: JavaScript&nbsp;<img style="aspect-ratio: 1/1; width: 22px;" src="./icons/javascript.svg" />, TypeScript&nbsp;<img style="aspect-ratio: 1/1; width: 22px;" src="./icons/typescript.svg" /> and much more...</p>
